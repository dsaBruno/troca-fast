...
-- CreateTable
CREATE TABLE `product_not_ordered` (
    `id` VARCHAR(191) NOT NULL,
...
-- AddForeignKey
ALTER TABLE `product_not_ordered` ADD CONSTRAINT `product_not_ordered_request_id_fkey` FOREIGN KEY (`request_id`) REFERENCES `requests`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
